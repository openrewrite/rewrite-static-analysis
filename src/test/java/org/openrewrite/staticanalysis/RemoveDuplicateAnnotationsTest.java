...
class RemoveDuplicateAnnotationsTest implements RewriteTest {
    ...
    @Test
    void removeDuplicateAnnotationOfAnyTypeByDefault() {
        rewriteRun(
          spec -> spec.recipe(new RemoveDuplicateAnnotations(null)),
          //language=java
          java(
            """
              class Foo {
    ...
    @Test
    void retainAnnotationsWithDifferentArguments() {
        rewriteRun(
          spec -> spec.recipe(new RemoveDuplicateAnnotations(null)),
          //language=java
          java(
    ...
    @Test
    void retainRepeatableAnnotations() {
        rewriteRun(
          spec -> spec.recipe(new RemoveDuplicateAnnotations(null)),
          //language=java
          java(
