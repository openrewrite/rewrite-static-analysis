...
public class UseJavaStyleArrayDeclarations extends Recipe {
    ...
    final String description = "Change C-Style array declarations `int i[];` to `int[] i;`. " +
            "Keeping the brackets with the type groups all type information in one place, so readers do not have to inspect both the type and the variable name to determine whether something is an array.";
