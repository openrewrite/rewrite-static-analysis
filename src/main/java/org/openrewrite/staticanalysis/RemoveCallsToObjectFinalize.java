...
public class RemoveCallsToObjectFinalize extends Recipe {
    ...
    @Getter
    final String description = "Remove calls to `Object.finalize()`. This method is called " +
            "during garbage collection and calling it manually is misleading. " +
            "Explicit finalize invocations can trigger resource cleanup " +
            "prematurely while the object is still in use, leading to " +
