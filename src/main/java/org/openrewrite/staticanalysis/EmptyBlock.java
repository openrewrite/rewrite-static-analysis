...
public class EmptyBlock extends Recipe {
    ...
    final String description = "Remove empty blocks that effectively do nothing. " +
            "Empty blocks are ambiguous -- they may indicate incomplete implementation or accidentally deleted code -- and removing them makes the intent of the surrounding code explicit.";
